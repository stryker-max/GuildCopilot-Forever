...
1. Das Paket `GuildCopilotForever-0.1.0-beta.8.zip` entpacken.
...
Ausgabe: `build/GuildCopilotForever-0.1.0-beta.8.zip` und `build/SHA256.json`. Lizenz: MIT, ursprüngliche Urheberschaft des Guild Copilot Teams bleibt erhalten.
