...
local english = {
    ...
    ["Ziehen: am Minimap-Rand. Umschalt + Ziehen: frei platzieren. Normales Ziehen heftet es wieder an."] = "Drag: along the minimap edge. Shift + drag: position freely. Drag normally to dock again.",
    ["Ziehen: entlang des Minimap-Rands"] = "Drag: along the minimap edge",
    ["Umschalt + Ziehen: frei platzieren"] = "Shift + drag: position freely",
